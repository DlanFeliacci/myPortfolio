...
const Work = () => {
  return (
    <div name="work" className="w-full h-[1800px] sm:h-[1200px] bg-[#0a192f] text-gray-300 p-2">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full pt-18">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div
            ...
            className="shadow-lg shadow-[#705693] group container rounded-md hover:border-2 border-2 flex justify-center items-center mx-auto">
            {/* Hover Effect */}
        ...
        <div className="flex flex-col mb-20">
          <div className="flex justify-center mt-10"><img src={decoration} alt="" className="w-[350px]"/></div>
